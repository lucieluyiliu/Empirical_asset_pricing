...
6. **Domain Specific Accuracy**:
    - **Financial Charts (SDF/Sharpe)**: If analyzing a chart regarding **Stochastic Discount Factors (SDF)** or **Sharpe Ratios**, enforce this rule: **The Sharpe slope is the line connecting the minimum SDF volatility point and zero**. Ensure any generated visualization or calculation respects this geometric relationship.
